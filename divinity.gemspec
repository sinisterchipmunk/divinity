...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".gitignore",
     ...
     "app_generators/divinity/templates/app/controllers/engine/application_controller.rb",
     "app_generators/divinity/templates/app/views/engine/application/index.rb",
     ...
     "tasks/jeweler.rake",
     "tasks/tests.rake",
     "test/app/app/controllers/engine/application_controller.rb",
     "test/app/app/views/engine/application/index.rb",
     "test/app/application.rb",
