...
srcdir = "C:\Program Files\JetBrains\RubyMine 2.0b\rb\testing\runner"
topdir = C:/ruby186-mswin/lib/ruby/1.8/i386-mswin32
hdrdir = $(topdir)
VPATH = $(srcdir);$(topdir);$(hdrdir)

DESTDIR = C:
prefix = $(DESTDIR)/ruby186-mswin
exec_prefix = $(prefix)
...
INCFLAGS = -I. -I. -IC:/ruby186-mswin/lib/ruby/1.8/i386-mswin32 -IC:\Program Files\JetBrains\RubyMine 2.0b\rb\testing\runner
CPPFLAGS =  
CXXFLAGS = $(CFLAGS) 
