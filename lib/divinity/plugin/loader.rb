...
module Divinity
  class Plugin
    class Loader
      ...
      # Divinity::Initializer. This default implementation automatically locates
      ...
      protected
        ...
        def add_engine_locales
          # reverse it such that the last engine can overwrite translations from the first
...
#          ActionMailer::Base.view_paths.concat(paths) if configuration.frameworks.include?(:action_mailer)
        ...
        # find the set of all plugins available to this Divinity application.
        def locate_plugins
