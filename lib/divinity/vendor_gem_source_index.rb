...
module Divinity
  class VendorGemSourceIndex
    ...
    def initialize(installed_index, vendor_dir=Divinity::GemDependency.unpacked_path)
    ...
    def refresh!
      ...
      # handle vendor Divinity gems - they are identified by having loaded_from set to ""
      ...
      Dir[File.join(Divinity::GemDependency.unpacked_path, '*')].each do |d|
