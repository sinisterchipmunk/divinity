class Engine::ApplicationController < Engine::Controller::Base
  def index
    @total_rotation = 0
    @distance = 10
    ...
    engine.look!                      # apply the current camera transformations - these should be defaults right now
  end

  # The #update method fires between frames, every frame. You can use this to safely process application logic that
  # doesn't fit in any model. TODO: Multithreading.
  def update
